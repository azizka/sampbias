...
The implications of not considering geographic sampling biases in biodiversity research are likely to be substantial [@Meyer2016; @Rocchini2015; @Shimadzu2015;  @Yang2013; @Kramer-Schadt2013; @Barbosa2013]. The presence of geographic sampling biases is broadly recognized [e.g. @Kadmon2004], and approaches exist to account for it in some analyses---such as for species-richness estimates [@Engemann2015], occupancy models [@Kery2016], and abundance estimates [@Shimadzu2015]. In the case of species distribution modelling---the statistical estimation of species geographic distributions based on known occurrences and environmental conditions--- geographically baised sampling is problematic if it a cause a biased sampling in the environmantal space. Multiple appraoches exist to adress biased sampling in the context of sdms [@Stolar2015;@Beck2014; @Fithian2014; @Warren2014; @Boria2014; @Varela2014; @Fourcade2014], for instance spatial thinning [@Aiello-Lammens2015] and selecting background points using a bias surface (so that they are equally biased as the presence records) [REFERENCES]. In contrast, few attempts have been made to explicitly quantify the overall bias [@Kadmon2004; @Hijmans2000] or to discern and quantify different sources of bias [@Fernandez2015; @Ruete2015; @Fithian2014; @Monsarrat2019]. To our knowledge, no tools exist for comparing the strength of bias factors or datasets. We define as *bias factors* any anthropogenic or natural features that facilitate human access and sampling, such as roads, rivers, airports, and cities.

Add references above and remove all those cited again from the first citation. add integration with other methods in as a future goal?!?
