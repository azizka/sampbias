...
[[*I wonder if this isn't in fact a posterior probability where f(x) is the prior and b(x,l) the likelihood or something like that*]]
...
[[*Actually I think this is effectively equivalent to what I worteabove $b(x,l) = \exp(-lx)$*]]
