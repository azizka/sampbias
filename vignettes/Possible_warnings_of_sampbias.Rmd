...
>Occurs if there are any NA entries in the `data` slot of the `SpatialPointsDataFrame` or `SpatialLinesDataFrame` objects used as gazetteers. Check the gazetteers and consider revising or excluding problematic entries.
