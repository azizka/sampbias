...
```{r, eval = TRUE, fig.height=7, fig.cap = "Output of a sampbias analysis. A) Posterior estimates of the bias weights for cities and roads, B) the decay of the sampling rate with increasing distance from cities and roads."}
summary(bias.out)
plot(bias.out)
```
